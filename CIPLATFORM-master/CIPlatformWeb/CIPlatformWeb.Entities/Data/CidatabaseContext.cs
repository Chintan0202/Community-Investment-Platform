...
namespace CIPlatformMain.Entities.Data;
...
public partial class CidatabaseContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
         => optionsBuilder.UseSqlServer("Server=FRIDAY;Database=CIDB;Trusted_Connection=True;TrustServerCertificate=True;Encrypt=True;");
       //  => optionsBuilder.UseSqlServer("Server = PCI156\\SQL2017; Database=CIDatabase;Persist Security Info=False;User ID = sa; Password=tatva123;MultipleActiveResultSets=False;Encrypt=False;TrustServerCertificate=False;Connection Timeout = 30;");
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Mission>(entity =>
        {
            ...
            entity.Property(e => e.MissionImg)
                .IsUnicode(false)
                .HasColumnName("mission_img");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__password__3213E83F5B691338");
        ...
        modelBuilder.Entity<User>(entity =>
        {
            ...
            entity.Property(e => e.UserId).HasColumnName("user_id");
            entity.Property(e => e.Avability)
                .HasMaxLength(50)
                .IsUnicode(false)
                .HasColumnName("avability");
